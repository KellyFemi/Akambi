    ...
    <div class="flex flex-col md:flex-row justify-between p-14 md:p-20">
      ...
      >
        <p class="text-center w-full">
          Les enquêtes de moralité sont essentielles dans de nombreux domaines
          tels que l'emploi, les partenariats commerciaux et les adoptions.
          Notre équipe d'enquêteurs compétents réalise des enquêtes approfondies
          pour évaluer l'honnêteté, l'intégrité et la moralité des individus
          concernés.
        </p>

        <p class="text-center w-full">
          Nous menons des vérifications approfondies des antécédents, y compris
          les antécédents professionnels, les références, les antécédents
          criminels et les comportements passés.
        </p>
        <p class="text-center w-full">
          Nos enquêtes de moralité fournissent des informations précieuses qui
          aident nos clients à prendre des décisions éclairées et à minimiser
          les risques potentiels liés à leurs interactions professionnelles ou
          personnelles.
        </p>
      </div>
