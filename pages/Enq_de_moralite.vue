<template>
    <div>
      ...
      <div class="background2-image flex  items-center justify-center place-content-center pt-24 h-64">
        ...
        <h1 class="h-full items-center text-3xl font-bold text-white">Enquêtes de moralité </h1>
      </div>
      ...
      <div class="flex space-x-20 p-14">
        ...
        >
          <p class="text-center w-[75%]">
            Les enquêtes de moralité sont essentielles dans de nombreux domaines tels que l'emploi, les partenariats commerciaux et les adoptions. Notre équipe d'enquêteurs compétents réalise des enquêtes approfondies pour évaluer l'honnêteté, l'intégrité et la moralité des individus concernés.          </p>
          <p class="text-center w-[75%]">
            Nous menons des vérifications approfondies des antécédents, y compris les antécédents professionnels, les références, les antécédents criminels et les comportements passés.          </p>
          <p class="text-center w-[75%]">
            Nos enquêtes de moralité fournissent des informations précieuses qui aident nos clients à prendre des décisions éclairées et à minimiser les risques potentiels liés à leurs interactions professionnelles ou personnelles.          </p>
        </div>
