    ...
    <div class="flex flex-col md:flex-row justify-between p-14 md:p-20">
      ...
      >
        <p class="text-center w-full">
          Notre service de surveillance professionnel est conçu pour répondre à
          vos besoins spécifiques en matière de surveillance. Que ce soit pour
          des raisons personnelles ou professionnelles, notre équipe
          expérimentée utilise des techniques de surveillance avancées pour
          collecter des informations précieuses.
        </p>

        <p class="text-center w-full">
          Nous sommes spécialisés dans la surveillance discrète et efficace des
          personnes, des lieux et des biens. Grâce à notre expertise en matière
          de surveillance, nous pouvons vous aider à obtenir les preuves
          nécessaires pour prendre des décisions éclairées et protéger vos
          intérêts.
        </p>

        <p class="text-center w-full">
          Notre approche personnalisée garantit que nous adaptons nos méthodes à
          votre situation spécifique, tout en respectant les normes de
          confidentialité et d'éthique les plus strictes.
        </p>
      </div>
