<template>
    <div>
      ...
      <div class="background2-image flex  items-center justify-center place-content-center pt-24 h-64">
        ...
        <h1 class="h-full items-center text-3xl font-bold text-white">Surveillance</h1>
      </div>
      ...
      <div class="flex space-x-20 p-14">
        ...
        >
          <p class="text-center w-[75%]">
            Notre service de surveillance professionnel est conçu pour répondre à vos besoins spécifiques en matière de surveillance. Que ce soit pour des raisons personnelles ou professionnelles, notre équipe expérimentée utilise des techniques de surveillance avancées pour collecter des informations précieuses. 
          </p>
          <p class="text-center w-[75%]">
            Nous sommes spécialisés dans la surveillance discrète et efficace des personnes, des lieux et des biens. Grâce à notre expertise en matière de surveillance, nous pouvons vous aider à obtenir les preuves nécessaires pour prendre des décisions éclairées et protéger vos intérêts. 
          </p>
          <p class="text-center w-[75%]">
            Notre approche personnalisée garantit que nous adaptons nos méthodes à votre situation spécifique, tout en respectant les normes de confidentialité et d'éthique les plus strictes.
          </p>
        </div>
