    ...
    <div class="flex flex-col md:flex-row justify-between p-14 md:p-20">
      ...
      >
        <p class="text-center w-full">
          Les enquêtes pré-nuptiales jouent un rôle crucial dans la prise de
          décision avant le mariage ou l'union légale. Notre équipe d'enquêteurs
          chevronnés réalise des enquêtes approfondies pour vous fournir une
          image claire de votre futur conjoint(e).
        </p>

        <p class="text-center w-full">
          Nous examinons attentivement des aspects tels que l'historique
          familial, les antécédents financiers, les comportements passés et
          d'autres informations pertinentes. Grâce à nos méthodes d'enquête
          approfondies et notre capacité à recueillir des informations précises,
          nous vous aidons à prendre une décision éclairée et à protéger vos
          intérêts à long terme.
        </p>

        <p class="text-center w-full">
          Notre approche professionnelle et confidentielle garantit que toutes
          les informations sont traitées avec le plus grand soin et respect de
          la vie privée.
        </p>
      </div>
