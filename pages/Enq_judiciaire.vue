<template>
    <div>
      ...
      <div class="background2-image flex  items-center justify-center place-content-center pt-24 h-64">
        ...
        <h1 class="h-full items-center text-3xl font-bold text-white">Enquêtes judiciaires </h1>
      </div>
      ...
      <div class="flex space-x-20 p-14">
        ...
        >
          <p class="text-center w-[75%]">
            Les enquêtes judiciaires sont menées pour recueillir des preuves et des informations pertinentes dans le cadre de procédures judiciaires. Notre équipe d'enquêteurs expérimentés est spécialisée dans la collecte d'informations juridiquement admissibles et dans la préparation de rapports complets pour une utilisation en cour.           </p>
          <p class="text-center w-[75%]">
            Nous travaillons en étroite collaboration avec les avocats et les clients pour comprendre les exigences spécifiques de chaque affaire.          </p>
          <p class="text-center w-[75%]">
            Notre expertise en matière d'enquêtes nous permet de trouver des preuves cruciales, d'interroger des témoins clés, de localiser des éléments de preuve et de fournir des informations essentielles pour soutenir le processus judiciaire.          </p>
        </div>
