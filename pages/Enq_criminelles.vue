    ...
    <div class="flex flex-col md:flex-row justify-between p-14 md:p-20">
      ...
      >
        <p class="text-center w-full">
          Les enquêtes criminelles sont au cœur de notre expertise. Notre équipe
          d'enquêteurs chevronnés collabore avec les autorités compétentes pour
          résoudre des affaires criminelles complexes. Nous utilisons des
          méthodes d'investigation avancées pour rassembler des preuves,
          identifier les suspects et contribuer à la poursuite de la justice.
        </p>
        <p class="text-center w-full">
          Nos enquêteurs sont formés pour mener des interrogatoires, analyser
          les scènes de crime, collecter des preuves matérielles et travailler
          en étroite collaboration avec des experts forensiques.
        </p>
        <p class="text-center w-full">
          Nous comprenons l'importance de chaque détail dans une enquête
          criminelle et nous nous efforçons de fournir des résultats fiables et
          solides pour aider à résoudre les affaires et protéger la société.
        </p>
      </div>
