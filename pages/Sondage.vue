<template>
    <div>
      ...
      <div class="background2-image flex  items-center justify-center place-content-center pt-24 h-64">
        ...
        <h1 class="h-full items-center text-3xl font-bold text-white">Sondage</h1>
      </div>
      ...
      <div class="flex space-x-20 p-14">
        ...
        >
          <p class="text-center w-[75%]">
            Les sondages sont des outils précieux pour recueillir des données et des opinions auprès d'un échantillon représentatif de la population. Notre équipe de professionnels en sondages est spécialisée dans la conception, la mise en œuvre et l'analyse de sondages dans divers domaines.           </p>
          <p class="text-center w-[75%]">
            Nous utilisons des méthodologies rigoureuses pour garantir la fiabilité et la validité des résultats. Nos services de sondage comprennent la création de questionnaires personnalisés, la collecte de données, l'analyse statistique et la présentation des résultats de manière claire et concise.           </p>
          <p class="text-center w-[75%]">
            Que ce soit pour des études de marché, des enquêtes d'opinion publique ou des évaluations de satisfaction client, nous sommes là pour vous fournir des informations précieuses basées sur des données solides.          </p>
        </div>
